...
- Day time vs night time averages (6-18, 18-6) 
...
- Issue: Rounding errors lead to some locations with more than 100 blocks
...
dat_air_quality_sum %>% 
  ...
  mutate(exposure_percent = case_when(
    ...
    location == "guardian" 
    & indicator == "pm2.5" 
    & air_quality == "Unhealthy" ~ exposure_percent - 1,
